...
#define STREAD( buf, length, num, st )				((st)->ReadShred.Read( (buf), (length), (StageNum), (st)->DataPoint ))
#define STWRITE( buf, length, num, st )				((st)->ReadShred.Write( (buf), (length), (StageNum), (st)->DataPoint ))
