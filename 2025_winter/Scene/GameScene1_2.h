...
{
public:
	GameScene1_2(SceneController& controller,PlayerType type,int hp);
...
private:
	...
	using UpdateFunc_t = void(GameScene1_2::*)(Input&);
	...
	void FadeOutDraw();
	void NormalDraw();
	using DrawFunc_t = void(GameScene1_2::*)();
